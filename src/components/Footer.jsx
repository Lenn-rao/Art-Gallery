...
function Footer() {
  return (
    <footer className="bg-secondary text-gray-300 mt-16"> {/* Added top margin */}
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Logo and description */}
          <div className="mb-8 md:mb-0">
            <Link to="/" className="text-2xl font-display font-bold text-white hover:text-primary transition-colors">
              Artistry
            </Link>
            <p className="mt-4 text-gray-400 font-body leading-relaxed text-sm">
              Discover unique art pieces from talented artists around the world.
              Our curated collection brings beauty and inspiration to your space.
            </p>
          </div>
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="space-y-2 font-body text-sm">
              ...
              <li><Link to="/products" className="text-gray-400 hover:text-primary transition-colors">Shop</Link></li>
              <li><Link to="/cart" className="text-gray-400 hover:text-primary transition-colors">Cart</Link></li>
              <li><Link to="/checkout" className="text-gray-400 hover:text-primary transition-colors">Checkout</Link></li>
            </ul>
          </div>

          {/* Contact info */}
          <div>
            <h3 className="text-lg font-display font-semibold mb-4 text-white">Contact Us</h3>
            <ul className="space-y-3 font-body text-sm text-gray-400">
              <li className="flex items-start"> {/* Use items-start for alignment */}
                ...
                123 Art Street, Creative City, AC 12345
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:contact@artistry.com" className="hover:text-primary transition-colors">contact@artistry.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
